...
function TradeModal({ isOpen, onClose, isSell, pid }: ModalProps) {
  const { config } = usePrepareContractWrite({
    addressOrName: "0x57de937c5fa3ac54b2bf73a2f91acb2d289d50dc",
    contractInterface: NexusProtocol.abi,
    functionName: "purchaseAsset",
    args: ["0xC0c4b8b83f34C317B0d95E34f75C31F7ed2DA41a", 1],
    overrides: {
            ...
            <VStack>
              ...
              <HStack className={styles.modalSubContainer}>
                ...
                <HStack className={styles.modalSubTextContainer}>
                  ...
                  <VStack alignItems="flex-end">
                    ...
                    <Text className={styles.modalSubtitle}>
                      ${(asset.price * 0.14).toFixed(2)} USD
                    </Text>
                  </VStack>
                </HStack>
              </HStack>
              ...
              <HStack>
                ...
                <ChakraLink
                  href={
                    txnData
                      ? `https://baobab.klaytnfinder.io/tx/${txnData.hash}`
                      : "https://baobab.klaytnfinder.io/tx/0x3cb7a402abcf26f8351a473af4e1a6c37fb77ec5296db47d1bccc63eacd5ad43"
                  }
                  isExternal
                >
              ...
              {pid != "128" ? (
                <HStack className={styles.modalSubContainer}>
                  ...
                  <HStack className={styles.modalSubTextContainer}>
                    ...
                    {!isSell && (
                      <VStack alignItems="flex-end">
                        <Text className={styles.modalTitle}>10 KLAY</Text>
              ...
              {[9.29, 6.12, 5.09].map((num) => (
                <HStack w="100%" key={num} pb="1rem">
                  ...
                  <VStack className={styles.historyLeftSection}>
                    <Text className={styles.historyTitle}>{num} KLAY</Text>
                    <Text className={styles.historySubtitle}>
                      ${(num * 0.14).toFixed(2)} USD
                    </Text>
                  </VStack>
                </HStack>
              ))}
